    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steam_waterproofing_external_walls', models.CharField(max_length=30, verbose_name='Парогидроизоляция')),
                ('steam_waterproofing_base_area', models.CharField(max_length=30, verbose_name='Парогидроизоляция')),
                ('windscreen_external_walls', models.CharField(max_length=30, verbose_name='Ветрозащита')),
                ('windscreen_base_area', models.CharField(max_length=30, verbose_name='Ветрозащита')),
                ('insulation_external_walls', models.CharField(max_length=30, verbose_name='Утеплитель')),
                ('insulation_base_area', models.CharField(max_length=30, verbose_name='Утеплитель')),
                ('OSB_for_interior_walls', models.CharField(max_length=30, verbose_name='ОСБ для внутренних стен')),
                ('OSB_for_external_walls', models.CharField(max_length=30, verbose_name='ОСБ для наружных стен')),
                ('OSB_for_base_area', models.CharField(max_length=30, verbose_name='ОСБ для потолка и пола')),
