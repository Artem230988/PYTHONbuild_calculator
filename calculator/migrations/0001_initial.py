    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OSB', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='ОСБ')),
                ('steam_waterproofing', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Парогидроизоляция')),
                ('windscreen', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Ветрозащита')),
                ('insulation', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Утеплитель')),
                ('OSB_for_interior_walls', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='ОСБ для внутренних стен')),
                ('OSB_for_sub_floor', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='ОСБ для чернового пола')),
                ('OSB_for_ceiling', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='ОСБ для потолка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length', models.DecimalField(blank=True, decimal_places=2, max_digits=10, verbose_name='Длина')),
                ...
                ('volume', models.DecimalField(blank=True, decimal_places=2, max_digits=10, verbose_name='Объем')),
                ('measurement_unit', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='materials_type', to='calculator.measurementunit', verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('openings', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='frame_openings', to='calculator.openings', verbose_name='Проемы')),
                ('structural_element_frame', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='frame_openings', to='calculator.structuralelementframe', verbose_name='Структурный элемент каркас')),
            ],
            options={
